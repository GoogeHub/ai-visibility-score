  ...
  return (
    <div style={{
      ...
      <div style={{ maxWidth: 820, margin: "0 auto", padding: "50px 40px 80px", textAlign: "center" }}>
        ...
        <p style={{ fontSize: 19, color: "#475569", lineHeight: 1.7, maxWidth: 560, margin: "0 auto 0" }}>
      ...
      {/* Final CTA */}
      <div style={{ backgroundColor: "#0f172a", padding: "0px 40px 200px", textAlign: "center" }}>
        <h2 style={{ fontSize: 34, fontWeight: 800, color: "#fff", margin: "0", letterSpacing: "-0.01em" }}>
